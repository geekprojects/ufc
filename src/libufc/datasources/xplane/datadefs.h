...
static const DataDefinition g_dataRefsInit[] =
{
    ...
    {"comms/com1Hz", INTEGER, offsetof(AircraftState, comms.com1Hz)},
    {"comms/com1StandbyHz", INTEGER, offsetof(AircraftState, comms.com1StandbyHz)},
    {"comms/com2Hz", INTEGER, offsetof(AircraftState, comms.com2Hz)},
    {"comms/com2StandbyHz", INTEGER, offsetof(AircraftState, comms.com2StandbyHz)},
    {"comms/nav1Hz", INTEGER, offsetof(AircraftState, comms.nav1Hz)},
    {"comms/nav1StandbyHz", INTEGER, offsetof(AircraftState, comms.nav1StandbyHz)},
    {"comms/nav2Hz", INTEGER, offsetof(AircraftState, comms.nav2Hz)},
    {"comms/nav2StandbyHz", INTEGER, offsetof(AircraftState, comms.nav2StandbyHz)},
