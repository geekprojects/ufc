...
class XPlaneDataSource : public DataSource
{
    ...
    void update(const std::map<int, AircraftValue> &values);
 ...
 public:
    ...
    void setData(const std::string& dataName, AircraftValue value) override;
    ...
    bool getDataString(const std::string &dataName, std::wstring &value) override;
