...
void AircraftState::init()
{
    ...
    set(DATA_AIRCRAFT_BAROMETER_PILOT_STD, 0);
    ...
    set(DATA_AUTOPILOT_FLIGHTDIRECTOR_PITCH, 0.0f);
    set(DATA_AUTOPILOT_FLIGHTDIRECTOR_ROLL, 0.0f);
    set(DATA_AUTOPILOT_FLIGHTDIRECTOR_MODE, false);
